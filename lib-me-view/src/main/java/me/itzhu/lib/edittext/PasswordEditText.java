...
public class PasswordEditText extends android.support.v7.widget.AppCompatEditText {
    ...
    public void init(AttributeSet attrs) {
        ...
        showDrawable = ContextCompat.getDrawable(getContext(), typedArray.getResourceId(R.styleable.CommonEdittext_passwordShowResource, R.drawable.ic_common_edittext_eye_show));
        hiddenDrawable = ContextCompat.getDrawable(getContext(), typedArray.getResourceId(R.styleable.CommonEdittext_passwordHiddenResource, R.drawable.ic_common_edittext_eye_hidden));
        typedArray.recycle();
        showPassword(false);
    }
